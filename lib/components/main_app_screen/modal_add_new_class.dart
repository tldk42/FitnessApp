...
class _ClassEditModalState extends State<ClassEditModal> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      padding: EdgeInsets
          .fromLTRB(10, 10, 0, MediaQuery.of(context).viewInsets.bottom),
      child: Padding(
          ...
          children: [
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Text("시작 날짜: ${_startDate != null ? "${_startDate!.day}/${_startDate!.month}/${_startDate!.year}" : ''}"),
              ),
            ),
            InkWell(
              onTap: () {
              ...
              child: Container(
                padding: EdgeInsets.symmetric(vertical: 10.0),
                child: Text("종료 날짜: ${_endDate != null ? "${_endDate!.day}/${_endDate!.month}/${_endDate!.year}" : ''}"),
              ),
            ),
            InkWell(
              onTap: () {
              ...
              child: Container(
                padding: EdgeInsets.symmetric(vertical: 10.0),
                child: Text("시작 시간: ${_startTime != null ? "${_startTime!.hour}:${_startTime!.minute}" : ''}"),
              ),
            ),
            InkWell(
              onTap: () {
              ...
              child: Container(
                padding: EdgeInsets.symmetric(vertical: 10.0),
                child: Text("종료 시간: ${_endTime != null ? "${_endTime!.hour}:${_endTime!.minute}" : ''}"),
              ),
            ),
            TextField(
              decoration: InputDecoration(labelText: 'Active Days (e.g. 월, 수, 금)'),
              onChanged: (value) {
                setState(() {
                  _activeDays = value;
                });
